...
ExternalProject_Add(
    ...
    DOWNLOAD_COMMAND ""
    CONFIGURE_COMMAND ""
    BUILD_COMMAND MFLAGS= MAKEFLAGS= WITH_TESTS=no WITH_BUILD_TOOLS=no WITH_ADDITIONAL_DOCUMENTATION=no WITH_PE=no WITH_ISA=no ${LIBELF_FLAGS} MAKEOBJDIR=${LIBELF_BUILD_DIR} bmake -C ${LIBELF_SRC} -e
    BUILD_IN_SOURCE 0
    INSTALL_COMMAND ""
